...
// bindata/v3.11.0/openshift-apiserver/trustedcacm.yaml
// DO NOT EDIT!
  ...
  template:
    ...
    spec:
      ...
      - name: openshift-apiserver
        ...
        args:
          -|
            if [ -f /var/run/configmaps/trusted-ca-bundle/tls-ca-bundle.pem ]; then
      ...
      - name: openshift-apiserver-watchdog
        ...
        args:
          ...
          - --process-name=openshift-apiserver
...
func v3110OpenshiftApiserverTrustedcacmYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "v3.11.0/openshift-apiserver/trustedcacm.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"v3.11.0/openshift-apiserver/trustedcacm.yaml":                  v3110OpenshiftApiserverTrustedcacmYaml,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"v3.11.0": {nil, map[string]*bintree{
		"openshift-apiserver": {nil, map[string]*bintree{
			...
			"trustedcacm.yaml":                  {v3110OpenshiftApiserverTrustedcacmYaml, map[string]*bintree{}},
		}},
	}},
}}
